...
def isrock():
   value = Atlas_options[str(random.randint(0,2))]
   if value == "Rock":
      match_result = "Match Draw"
   elif value=="Scissor":
      match_result = "Wohoo! You Won"
   else:
      match_result = "Atlas won!"
...
def reset():
   ...
   l3.config(text = "Atlas")
   label.config(text = "")

#Create a LabelFrame
labelframe= LabelFrame(win, text= "Rock Paper Scissor", font= ('Century 20 bold'),labelanchor= "n",bd=5,bg= "grey",width= 600, height= 450, cursor= "target")
...
#Label for VS!
l2= Label(labelframe, text="VS", font= ('Helvetica 18 bold'), bg="grey")
l2.place(relx= .45, rely= .1)

#Label for Atlas
l3= Label(labelframe, text="Atlas", font= ('Helvetica 18 bold'))
